...
mod cli_branch_test {
    ...
    fn test_should_transform_to_domain() {
        let cli_commit = CliBranchToCreate::new("toto".to_string(), false);
        let commit_to_create = cli_commit.to_domain();
        assert_eq!(commit_to_create.name(), "toto");
        assert_eq!(commit_to_create.is_current(), false);
    }
    ...
    fn test_should_display_cli_commit() {
        ...
        assert_eq!(cli_branch.to_display(), "toto | 2023-01-01 12:00:00 | true");
    }
}